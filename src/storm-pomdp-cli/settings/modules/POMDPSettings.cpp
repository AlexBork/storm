...
const std::string exportPolicyOption = "export-policy";
...
POMDPSettings::POMDPSettings() : ModuleSettings(moduleName) {
    ...
    this->addOption(
        storm::settings::OptionBuilder(moduleName, exportAsParametricModelOption, false, "Export the parametric file.")
            ...
            .build());
    this->addOption(
        storm::settings::OptionBuilder(moduleName, exportPolicyOption, false, "Export the policy generated by belief-space unfolding.")
            .addArgument(storm::settings::ArgumentBuilder::createStringArgument("filename", "The name of the file to which to write the policy.").build())
            .build());
...
bool POMDPSettings::isExportPolicySet() const {
    return this->getOption(exportPolicyOption).getHasOptionBeenSet();
}

std::string POMDPSettings::getExportPolicyFilename() const {
    return this->getOption(exportPolicyOption).getArgumentByName("filename").getValueAsString();
}
...
bool POMDPSettings::check() const {
    ...
    STORM_LOG_THROW(!isExportPolicySet() || isBeliefExplorationUnfoldSet(), storm::exceptions::InvalidArgumentException,
                    "Policy export requires belief-space unfolding. Use '--belief-exploration unfold' or '--belief-exploration both'.");
    return true;
}
