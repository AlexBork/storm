 ...
 *
 * @tparam PomdpValueType
 */
template<typename PomdpValueType>
struct POMDPValueBounds {
    // values generated by memoryless schedulers during pre-processing
    storm::pomdp::storage::PreprocessingPomdpValueBounds<PomdpValueType> trivialPomdpValueBounds;
    // values for clipping compensation
    storm::pomdp::storage::ExtremePOMDPValueBound<PomdpValueType> extremePomdpValueBound;
    ...
    std::vector<std::vector<std::unordered_map<uint64_t, PomdpValueType>>> fmSchedulerValueList;
};
/**
